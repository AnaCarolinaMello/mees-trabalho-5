...
-**`desenho_experimento.md`**: Desenho completo do experimento com todas as definições necessárias
...
3. Consulte `README_EXPERIMENTO.md` para mais detalhes
4. Consulte `desenho_experimento.md` para entender o experimento
